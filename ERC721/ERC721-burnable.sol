...
/**
 * @title NFT Sale with burnable NFTs
 * @author Breakthrough Labs Inc.
 * @notice NFT, Sale, ERC721, Burnable
 * @custom:version 1.0.8
 * @custom:address 8
 * @custom:default-precision 0
 * @custom:simple-description An NFT with a built in sale. NFT holders can burn their NFTs
...
contract BurnableNFT is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
